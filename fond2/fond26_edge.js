...
(function (compId) {
                    ...
                    dom: [
                        {
                            ...
                            opacity: 1,
                            fill: ["rgba(0,0,0,0)","http://vovaane.github.io/fond2/images/%D0%A4%D0%9E%D0%9D%D0%94.gif",'0px','0px']
                        },
                        {
                            id: 'gift',
                            display: 'block',
                            ...
                            opacity: 1,
                            fill: ["rgba(0,0,0,0)","http://vovaane.github.io/fond2/images/gift.png",'0px','0px']
                        },
                        {
                            id: 'Text3',
                            display: 'block',
                        ...
                        },
                        {
                            ...
                            opacity: 1,
                            fill: ["rgba(0,0,0,0)","http://vovaane.github.io/fond2/images/%D0%BF%D0%BE%D0%B4%D0%B0%D1%80%D0%BE%D0%BA.png",'0px','0px']
                        },
                        {
                            id: 'Text8',
                            display: 'none',
                        ...
                        },
                        {
                            ...
                            fill: ["rgba(0,0,0,0)","http://vovaane.github.io/fond2/images/agyta.jpg",'0px','0px']
                        }
                    ],
                    style: {
                        '${Stage}': {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("http://vovaane.github.io/fond2/fond26_edgeActions.js");
})("EDGE-231929459");
